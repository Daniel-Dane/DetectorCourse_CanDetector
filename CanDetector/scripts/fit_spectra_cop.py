...
import common
common.show_title_subtitle = "(Cu pipe)"
...
ax.legend(loc='best')
fig.show()
plt.savefig("../graphics/cupbkgsubtraction.pdf", format='pdf')
...
[_, fe_esc_mean, _], [_, fe_esc_unc, _], fe_esc_chi2, fe_esc_ndof, fe_esc_prob = fit_and_draw_ROOT( h_fe_new, gauss_single, [4410, 45.74, 4.15], ax, [37,50] )

[N, r, fe_mean, fe_sigma, fe_sec_mean, fe_sec_sigma], [_, _, fe_unc, _, fe_sec_unc, _], fe_chi2, fe_ndof, fe_prob = fit_and_draw_ROOT( h_fe_new, gauss_double_uncorr, [50_000, 0.64, 88, 5.5, 96, 6.4], ax, [75,105], draw_individually=True, dont_plot_hist=True, bounds=([0,0.1,85,2,90,3],[100_000,1,95,10,110,9]) )
...
[am_c, am_mean, am_sigma, _, _], [_, am_unc, _, _, _], am_chi2, am_ndof, am_prob = fit_and_draw_ROOT( h_am_new, gauss_p1, [4722, 123, 6.6,10.6,0.54], None, [110, 140], ax2=ax2, bounds=([10,115,2,0,-100],[10_000,131,10,100,100]) )
...
# spice it up and show
x=0.9
ax2.set_ylim(top=1.25*ax2.get_ylim()[1])
...
f.show()
plt.savefig("../graphics/cupchannelfits.pdf", format='pdf')
...
# do fit
y = [ fe_escape_energy, fe_main_energy, fe_sec_energy, 8.2 ]#, am_main_energy ]
x = [ fe_esc_mean, fe_mean, fe_sec_mean, am_mean ]
yerr = [ fe_escape_energy_unc, fe_main_energy_unc, fe_sec_energy_unc, 0.01 ]#, am_main_energy_unc ]
