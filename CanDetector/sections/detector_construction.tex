...
\begin{table}[H]
  \begin{tabularx}{\linewidth}{p{3.7cm}p{0.9cm}|X}
    \textbf{Element}           &               & \textbf{Measurements} \\ \hline
    Cider can diameter         & $D_{outer}$   & $65.8 \pm 0.1 $mm     \\
    Cider can wall thickness   & $\tau$        & $\SI{105 \pm 10}{\micro\meter}$   \\
    ...
    Anode wire diameter        & $d_{wire}$    & $\SI{50 \pm 10}{\micro\meter}$    \\
    \hline
  \end{tabularx}
...
\begin{table}[H]
	\begin{tabularx}{\linewidth}{p{5.5cm}|X}
		...
		HV front end,  total length         & $36.8$  \\
		HV front end, top part length       & $15.9$  \\
		HV front end, tube extremity radius & $19.8$  \\
		back end, total length              & $15.0$  \\
		back end, top part length           & $5.1$   \\
		back end, tube extremity radius     & $19.9$  \\
		Brass tube diameter                 & $1.0$    \\
		Anode wire thickness                & $0.025$  \\
                \hline
	\end{tabularx}
\caption{TODO: Calculate actual mean. Measurements of the copper pipe experiment setup components. The ends are made of tefon.}
