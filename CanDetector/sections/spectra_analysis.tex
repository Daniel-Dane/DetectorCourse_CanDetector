...
\begin{figure*}[htb]
  ...
  %\includegraphics[width=0.32\textwidth]{graphics/cupbkgsubtraction.pdf}
...
\begin{tabular}[c]{@{}l@{}}Uncorrelated\\ double gaussian\end{tabular}  & $N\left[r\frac{1}{\sqrt{2\pi}\sigma}\exp{\left(-\frac{\left(x-\mu\right)^2}{2\sigma^2}\right)}+(1-r)\frac{1}{\sqrt{2\pi}\sigma}\exp{\left(-\frac{\left(x-\mu\right)^2}{2\sigma^2}\right)}\right]$                     \\
\begin{tabular}[c]{@{}l@{}}Gaussian plus\\ 1st order poly.\end{tabular} & $\frac{N}{\sqrt{2\pi}\sigma}\exp{\left(-\frac{\left(x-\mu\right)^2}{2\sigma^2}\right)} + b + ax$                   
\end{tabular}
