...
\todo[inline]{spectra: table of all peaks and energies for can and alu}
\todo[inline]{spectra: final figure and the 4 gauss simultaneous fit for can}
\todo[inline]{spectra: comment on splitting uncertainties into stat. and calib.}
