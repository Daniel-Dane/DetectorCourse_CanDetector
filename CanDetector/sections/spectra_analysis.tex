...
In this section, the figures for the aluminium detector assumbled by group 2 and the can detector will be shown side-by-side with the can detector on the left and the aluminium detector on the right.
